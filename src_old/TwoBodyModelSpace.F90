    ...
    do loop = 1, 9
      ...
      do i1 = 1, sps%norbs
        ...
        do i2 = 1, i1
          ...
          if(.not. (loop == 1 .and. o1%ph == 0 .and. o2%ph == 1)) cycle ! hp states
          if(.not. (loop == 2 .and. o1%ph == 1 .and. o2%ph == 0)) cycle ! ph states
          if(.not. (loop == 3 .and. o1%ph == 0 .and. o2%ph == 0)) cycle ! hh states
          if(.not. (loop == 4 .and. o1%ph == 0 .and. o2%ph == 2)) cycle ! hv states
          if(.not. (loop == 5 .and. o1%ph == 2 .and. o2%ph == 0)) cycle ! vh states
          if(.not. (loop == 6 .and. o1%ph == 2 .and. o2%ph == 2)) cycle ! vv states
          if(.not. (loop == 7 .and. o1%ph == 2 .and. o2%ph == 1)) cycle ! vp states
          if(.not. (loop == 8 .and. o1%ph == 1 .and. o2%ph == 2)) cycle ! pv states
          if(.not. (loop == 9 .and. o1%ph == 1 .and. o2%ph == 1)) cycle ! pp states
      ...
      if(loop == 1) this%n_hp_state = cnt_sub
      if(loop == 2) this%n_hp_state = this%n_hp_state + cnt_sub
      if(loop == 3) this%n_hh_state = cnt_sub
      if(loop == 4) this%n_hv_state = cnt_sub
      if(loop == 5) this%n_hv_state = this%n_hv_state + cnt_sub
      if(loop == 6) this%n_vv_state = cnt_sub
      if(loop == 7) this%n_vp_state = cnt_sub
      if(loop == 8) this%n_vp_state = this%n_vp_state + cnt_sub
