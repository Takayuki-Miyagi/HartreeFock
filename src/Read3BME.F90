module read_3BME
  ...
  type :: iThreeBodyChannel
    ...
    real(8) :: usedmem = 0.d0
  contains
    procedure :: init => InitiThreeBodyChannel
    procedure :: fin => FiniThreeBodyChannel
...
contains
  ...
  subroutine InitiThreeBodySpace(this, sps, params)
    ...
    do ich = 1, this%n
      call this%jpt(ich)%init(params, sps, this%j(ich), this%p(ich), this%t(ich))
